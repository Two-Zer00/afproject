...
const menuHTML =
  ...
  "</li>" +
  '<li class="nav-item d-flex align-items-center bg-logo rounded-circle p-2 m-1" style="width: 40px;">' +
  '<img src="/staticFiles/aproject.svg" tabindex="-1" alt="logo" clas="user-selection-none" style="width:100%;">' +
  "</li>" +
